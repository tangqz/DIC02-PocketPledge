...
export const CHARACTER_MARKET: CharacterProfile[] = [
  {
    id: "milly",
    displayName: "Milly",
    shortDescription: "Warm emotional companion",
    personality: "Empathetic and lively. She validates feelings first, then gently helps you regain rhythm.",
  ...
  },
  {
    id: "ren",
    displayName: "Natori",
    shortDescription: "Calm mindfulness coach",
    personality: "Grounded and gentle. Helps users breathe, reflect, and take one small step at a time.",
