...
def login(payload: LoginRequest, db: Session = Depends(get_db)):
    ...
    # By verifying against a valid-format DUMMY_HASH when the user doesn't exist,
    # the time taken to respond is roughly equal, hiding whether the username is valid.
